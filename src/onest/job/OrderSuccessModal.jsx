        ...
        <Modal isOpen={isOpen} onClose={onClose}>
            ...
            <ModalContent textAlign={'center'} padding={10}>
                ...
                <ModalBody textAlign={'center'}  alignSelf={'center'} marginTop={7}>
                    <Box padding={3} marginLeft={10} width={250} background={'gray.600'}> <Text color={'white'} fontWeight={500}> {orderId}</Text></Box>

                    <Text my={4} textTransform="capitalize">{localStorage.getItem('instructionsValue')}</Text>
                </ModalBody>
            </ModalContent>
        </Modal>
    );
